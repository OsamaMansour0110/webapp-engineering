...
export default function ServicesSection() {
  return (
    <section className="py-20 px-6 container mx-auto">
      <h2 className="text-5xl font-serif font-bold text-center mb-16 text-[var(--foreground)] tracking-widest uppercase transition-colors">Our Services</h2>
          ...
          >
            ...
            <div className="absolute inset-0 flex items-center justify-center">
              <div className="glass px-10 py-5 rounded-lg border border-white/10 backdrop-blur-md shadow-lg group-hover:bg-primary/10 group-hover:border-primary/40 transition-all duration-500">
                <h3 className="text-3xl font-bold font-serif text-white tracking-wide text-center group-hover:text-primary transition-colors duration-500">
                  {service.title}
                </h3>
              </div>
            </div>
            ...
            <div className="absolute bottom-6 right-6">
              <div className="bg-black/80 px-4 py-2 rounded-md border border-white/5 backdrop-blur-sm shadow-md">
                <p className="text-sm font-semibold text-white/90 tracking-wider group-hover:text-primary transition-colors duration-500">
                  {service.slogan}
                </p>
              </div>
            </div>
